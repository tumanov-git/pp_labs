"""
Демонстрационный скрипт для предметной области системы бронирования курорта.
Создаёт примеры объектов через ResortStorage и демонстрирует CRUD-операции.
Отображает исключения и ошибки работы с хранилищем.
Сохраняет и загружает данные в JSON и XML.
"""
